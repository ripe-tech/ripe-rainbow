...
class EventsTest(unittest.TestCase):
    def test_event_stringifier(self):
        ...
        self.assertEqual(
            stringifier, ripe_rainbow.interactive.events.stringify_request_will_be_sent
        )

        event = "Network.responseReceived"
        stringifier = ripe_rainbow.interactive.events.EVENT_STRINGIFIERS[event]
        self.assertEqual(
            stringifier, ripe_rainbow.interactive.events.stringify_response_received
        )
    ...
    def test_stringify_response_received(self):
        ...
        self.assertEqual(
            log,
            "Network.responseReceived 3D8A8C5C9832597801E08A06FA29E4C0 200 https://platforme.com {'Access-Control-Allow-Origin': '*'}",
        )
    ...
    def test_stringify_request_will_be_sent(self):
        ...
        self.assertEqual(
            log,
            "Network.requestWillBeSent 3D8A8C5C9832597801E0 GET https://platforme.com {'User-Agent': 'Mozilla/5.0 (X11; Linux x86_64)'}",
        )
