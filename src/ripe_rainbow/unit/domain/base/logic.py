...
class LogicPartTest(unittest.TestCase):
    def test_match_url(self):
        ...
        self.assertEqual(
            logic_part.match_url("http://www.platforme.com", "http://www.platforme.com"),
            True,
        )
        self.assertEqual(
            logic_part.match_url("http://www.platforme.com", "http://www.platforme.come"),
            False,
        )
        self.assertEqual(
            logic_part.match_url("http://www.platforme.com", "http://www.platforme.co"),
            False,
        )

        self.assertEqual(
            logic_part.match_url(
                "http://www.platforme.com", "http://www.platforme.com?param1=value1"
            ),
            True,
        )
        self.assertEqual(
            logic_part.match_url(
                "http://www.platforme.com?param1=value1", "http://www.platforme.com"
            ),
            True,
        )
